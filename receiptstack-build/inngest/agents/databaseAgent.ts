...
const saveToDatabaseTool=createTool({
    ...
    parameters: z.object({
        ...
        transactionAmount: z
            .string()
            .describe("The total amount of transaction, summing all the items on the receipt."),
        receiptSummary: z
            .string()
            .describe(
...
export const databaseAgent=createAgent({
    ...
    system: "You are a helpful assistant that takes key information regatding receipts and saves it to the convex database.",
    model: openai({
        model: "gpt-4o-mini",
        defaultParameters: {
